...
# Keep this example configuration immutable while assigning a unique result
# name to each process tree through an inherited environment variable.
TEST_MODE_OUTPUT_ID = os.environ.get("EASYSATSIM_TEST_MODE_OUTPUT_ID", "manual")
AUTO_ASSIGN_SAVE_FILE_PATH = False
SAVE_FILE_PATH = (
    "../examples/test_mode_example/output/"
    f"easysatsim_result_test_mode_{TEST_MODE_OUTPUT_ID}.csv"
)
